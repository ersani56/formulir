                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label for="ijazah" class="block text-sm font-medium text-gray-700 mb-2">
                                Ijazah SD s/d Terakhir <span class="text-red-500">*</span>
                                <span class="text-xs text-gray-500">(bisa upload beberapa file sekaligus)</span>
                            </label>
                        ...
                        <div>
                            <label for="transkrip_nilai" class="block text-sm font-medium text-gray-700 mb-2">
                                Transkrip Nilai SD s/d Teralhir<span class="text-red-500">*</span>
                                <span class="text-xs text-gray-500">(bisa upload beberapa file sekaligus)</span>
                            </label>
