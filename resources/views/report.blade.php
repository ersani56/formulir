        ...
        <div class="bg-white rounded-lg shadow-lg p-6 mb-6">
            <div class="flex justify-between items-center">
                <div>
                    ...
                    <p class="text-gray-600">BKPSDM - Badan Kepegawaian dan Pengembangan Sumber Daya Manusia</p>
                </div>
    ...
    <script>
        ...
        function updateRecentUploads(uploads) {
            ...
            uploads.forEach(upload => {
                ...
                const fileCount = [upload.drh_path, upload.skcpns_path, upload.skpns_path, upload.spmt_path]
                    .filter(Boolean).length;

                item.innerHTML = `
                    <div>
                        <div class="font-medium">${upload.nip}</div>
                        <div class="text-sm text-gray-500">${fileCount} file(s)</div>
                    </div>
                    <div class="text-sm text-gray-500">
                        ${new Date(upload.updated_at).toLocaleDateString('id-ID')}
                    </div>
                `;
